...
class ForgotPasswordChangePassword extends StatelessWidget {
  @override
    ...
    return Column(
      ...
      children: <Widget>[
        Align(
            ...
            child: Text("Change Password (3 of 4)",
        ...
        TextFormField(
          decoration: InputDecoration(
              labelText: "Confirm Password", hasFloatingPlaceholder: true),
        ),
        SizedBox(
          height: 100,
        ),
              ...
              FlatButton(
                ...
                onPressed: () {
                  _data.setStartupScreenMode(
                      StartupScreenMode.FORGOTPASSWORDCONFIRMATION);
                },
              )
            ],
          ),
